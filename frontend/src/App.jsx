...
const PRODUCTS = [
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 892,
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSuLQZ6YCvDkLjhS1UNgaOwgkZ5wwlZqwm82Q&s",
...
function App() {
  ...
  const sendMessage = async (message, productContext = null) => {
    ...
    try {
      ...
      const userId = 'default-user'; // Você pode implementar um sistema de usuários depois
      const backendUrl = `http://127.0.0.1:8000/user/${userId}/perguntar`;
